...
@Service
public class TransactionUpdateCommand implements ResultCommandInterface<Product> {
	@Transactional
	@Override
	...
	public TransactionUpdateCommand setProductId(final UUID productId) {
	...
	public TransactionUpdateCommand setApiProduct(final Product apiProduct) {
